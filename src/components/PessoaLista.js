...
class PessoaLista extends Component{
    render(){
        ...
        return (
            ...
            /*filhos em linha, margem abaixo de cada um, borda,
              centralizado horizontalmente */
            <div key={pessoa.nome} className="flex flex-row mb-2 w-6 border border-round 
                border-1 border-400 justify-content-center">
                    {/* padding, largura */}
                    <div className="p-2 w6">
...
const resultadoDaConnect = connect(mapStateToProps, {selecionarPessoa})
